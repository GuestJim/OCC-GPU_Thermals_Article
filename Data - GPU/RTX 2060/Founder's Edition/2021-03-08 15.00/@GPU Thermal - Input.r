...
if (interactive())	{
	# setwd("C:/Users/packe/Desktop/Open Share/@Thermal Scripts/Data GPU/RTX 2060/Founder's Edition/2021-03-08 15.00/")
	setwd("E:/Users/Jim/My Documents/OCC/@Reviews/Thermal Scripts Articles/Data GPU/RTX 2060/Founder's Edition/2021-03-08 15.00")
}	else	{
	pdf(NULL)
}
