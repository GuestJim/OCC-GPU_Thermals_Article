...
if (interactive())	{
	# setwd("C:/Users/packe/Desktop/Open Share/@Thermal Scripts/Data GPU/GTX 1070/Founder's Edition/2021-03-15 20.43/")
	setwd("E:/Users/Jim/My Documents/OCC/@Reviews/Thermal Scripts Articles/Data GPU/GTX 1070/Founder's Edition/2021-03-15 20.43")
}	else	{
	pdf(NULL)
}
