...
if (interactive())	{
	# setwd("C:/Users/packe/Desktop/Open Share/@Thermal Scripts/Data GPU/GTX 1070/Founder's Edition/2021-07-02 08.00/")
	setwd("E:/Users/Jim/My Documents/OCC/@Reviews/Thermal Scripts Articles/Data GPU/GTX 1070/Founder's Edition/2021-07-02 08.00")
}	else	{
	pdf(NULL)
}
