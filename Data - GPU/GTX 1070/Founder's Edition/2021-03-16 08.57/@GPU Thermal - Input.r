...
zRPM		=	NULL
maxPWR		=	NULL
FREQspec	=	c(1506, 1683)
pulseTSoff	=	0

if (interactive())	{
	# setwd("C:/Users/packe/Desktop/Open Share/@Thermal Scripts/Data GPU/GTX 1070/Founder's Edition/2021-03-16 08.57/")
	setwd("E:/Users/Jim/My Documents/OCC/@Reviews/Thermal Scripts Articles/Data GPU/GTX 1070/Founder's Edition/2021-03-16 08.57")
}	else	{
	pdf(NULL)
}
