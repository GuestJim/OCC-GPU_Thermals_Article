...
if (interactive())	{
	# setwd("C:/Users/packe/Desktop/Open Share/@Thermal Scripts/Data GPU/GTX 980/Founder's Edition/2021-03-16 11.11/")
	setwd("E:/Users/Jim/My Documents/OCC/@Reviews/Thermal Scripts Articles/Data GPU/GTX 980/Founder's Edition/2021-03-16 11.11/")
}	else	{
	pdf(NULL)
}
