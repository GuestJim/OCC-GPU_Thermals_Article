...
if (interactive())	{
	# setwd("C:/Users/packe/Desktop/Open Share/@Thermal Scripts/Data GPU/GTX 980/Founder's Edition/2021-07-01 17.35/")
	setwd("E:/Users/Jim/My Documents/OCC/@Reviews/Thermal Scripts Articles/Data GPU/GTX 980/Founder's Edition/2021-07-01 17.35")
}	else	{
	pdf(NULL)
}
