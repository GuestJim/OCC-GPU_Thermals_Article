...
if (interactive())	{
	# setwd("C:/Users/packe/Desktop/Open Share/@Thermal Scripts/Data GPU/GTX 1080/Founder's Edition/2021-03-15 12.27/")
	setwd("E:/Users/Jim/My Documents/OCC/@Reviews/Thermal Scripts Articles/Data GPU/GTX 1080/Founder's Edition/2021-03-15 12.27")
}	else	{
	pdf(NULL)
}
