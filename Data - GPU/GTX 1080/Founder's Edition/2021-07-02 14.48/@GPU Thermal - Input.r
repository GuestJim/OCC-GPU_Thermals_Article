...
if (interactive())	{
	# setwd("C:/Users/packe/Desktop/Open Share/@Thermal Scripts/Data GPU/GTX 1080/Founder's Edition/2021-07-02 14.48/")
	setwd("E:/Users/Jim/My Documents/OCC/@Reviews/Thermal Scripts Articles/Data GPU/GTX 1080/Founder's Edition/2021-07-02 14.48")
}	else	{
	pdf(NULL)
}
