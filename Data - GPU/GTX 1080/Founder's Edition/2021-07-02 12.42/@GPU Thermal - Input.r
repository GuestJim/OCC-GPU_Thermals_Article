...
zRPM		=	NULL
maxPWR		=	NULL
FREQspec	=	c(1607, 1733)
pulseTSoff	=	9

if (interactive())	{
	# setwd("C:/Users/packe/Desktop/Open Share/@Thermal Scripts/Data GPU/GTX 1080/Founder's Edition/2021-07-02 12.42/")
	setwd("E:/Users/Jim/My Documents/OCC/@Reviews/Thermal Scripts Articles/Data GPU/GTX 1080/Founder's Edition/2021-07-02 12.42")
}	else	{
	pdf(NULL)
}
