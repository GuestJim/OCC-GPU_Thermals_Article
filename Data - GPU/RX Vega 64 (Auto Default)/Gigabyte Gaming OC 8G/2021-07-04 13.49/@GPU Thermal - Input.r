...
duration	=	3600
warm		=	300
TESTname	=	"3DMark - Fire Strike - Loop"
...
if (interactive())	{
	# setwd("C:/Users/packe/Desktop/Open Share/@Thermal Scripts/Data GPU/RX Vega 64 (Auto Default)/Gigabyte Gaming OC 8G/2021-07-04 13.49/")
	setwd("E:/Users/Jim/My Documents/OCC/@Reviews/Thermal Scripts Articles/Data GPU/RX Vega 64 (Auto Default)/Gigabyte Gaming OC 8G/2021-07-04 13.49")
}	else	{
	pdf(NULL)
}
