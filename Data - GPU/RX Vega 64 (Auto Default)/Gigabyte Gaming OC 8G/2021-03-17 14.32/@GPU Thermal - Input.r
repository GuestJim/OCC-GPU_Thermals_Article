...
if (interactive())	{
	# setwd("C:/Users/packe/Desktop/Open Share/@Thermal Scripts/Data GPU/RX Vega 64 (Auto Default)/Gigabyte Gaming OC 8G/2021-03-17 14.32/")
	setwd("E:/Users/Jim/My Documents/OCC/@Reviews/Thermal Scripts Articles/Data GPU/RX Vega 64 (Auto Default)/Gigabyte Gaming OC 8G/2021-03-17 14.32")
}	else	{
	pdf(NULL)
}
