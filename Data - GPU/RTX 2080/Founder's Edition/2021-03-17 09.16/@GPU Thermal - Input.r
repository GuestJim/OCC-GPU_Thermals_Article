...
if (interactive())	{
	# setwd("C:/Users/packe/Desktop/Open Share/@Thermal Scripts/Data GPU/RTX 2080/Founder's Edition/2021-03-17 09.16/")
	setwd("E:/Users/Jim/My Documents/OCC/@Reviews/Thermal Scripts Articles/Data GPU/RTX 2080/Founder's Edition/2021-03-17 09.16")
}	else	{
	pdf(NULL)
}
