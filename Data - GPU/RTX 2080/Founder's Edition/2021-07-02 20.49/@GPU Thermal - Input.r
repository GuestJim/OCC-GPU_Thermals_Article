...
if (interactive())	{
	# setwd("C:/Users/packe/Desktop/Open Share/@Thermal Scripts/Data GPU/RTX 2080/Founder's Edition/2021-07-02 20.49/")
	setwd("E:/Users/Jim/My Documents/OCC/@Reviews/Thermal Scripts Articles/Data GPU/RTX 2080/Founder's Edition/2021-07-02 20.49")
}	else	{
	pdf(NULL)
}
