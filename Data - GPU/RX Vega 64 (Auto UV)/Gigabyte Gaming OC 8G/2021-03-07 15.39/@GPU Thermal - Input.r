...
if (interactive())	{
	# setwd("C:/Users/packe/Desktop/Open Share/@Thermal Scripts/Data GPU/RX Vega 64 (Auto UV)/Gigabyte Gaming OC 8G/2021-03-07 15.39/")
	# setwd("E:/Users/Jim/My Documents/OCC/@Reviews/@Thermal Scripts/Data GPU/RX Vega 64 (Auto UV)/Gigabyte Gaming OC 8G/2021-03-07 15.39/")
	setwd("E:/Users/Jim/My Documents/OCC/@Reviews/Thermal Scripts Articles/Data GPU/RX Vega 64 (Auto UV)/Gigabyte Gaming OC 8G/2021-03-07 15.39/")
}	else	{
	pdf(NULL)
}
