...
if (interactive())	{
	# setwd("C:/Users/packe/Desktop/Open Share/@Thermal Scripts/Data GPU/FX Vega 64 (Auto UV)/Gigabyte Gaming OC 8G/2021-07-04 11.33/")
	setwd("E:/Users/Jim/My Documents/OCC/@Reviews/Thermal Scripts Articles/Data GPU/RX Vega 64 (Auto UV)/Gigabyte Gaming OC 8G/2021-07-04 11.33")
}	else	{
	pdf(NULL)
}
