...
if (interactive())	{
	# setwd("C:/Users/packe/Desktop/Open Share/@Thermal Scripts/Data GPU/GTX 770/EVGA ACX/2021-07-01 15.08/")
	setwd("E:/Users/Jim/My Documents/OCC/@Reviews/Thermal Scripts Articles/Data GPU/GTX 770/EVGA ACX/2021-07-01 15.08")
}	else	{
	pdf(NULL)
}
