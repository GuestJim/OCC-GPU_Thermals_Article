...
if (interactive())	{
	# setwd("C:/Users/packe/Desktop/Open Share/@Thermal Scripts/Data GPU/GTX 770/EVGA ACX/2021-03-16 19.16/")
	setwd("E:/Users/Jim/My Documents/OCC/@Reviews/Thermal Scripts Articles/Data GPU/GTX 770/EVGA ACX/2021-03-16 19.16")
}	else	{
	pdf(NULL)
}
